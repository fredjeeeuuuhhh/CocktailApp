...
object IngredientSampler {
    ...
    val getIngredients: () -> MutableList<Ingredient> = {
        ingredients
    }

    val getCategories: ()-> MutableList<String> = {
        mutableListOf("Ordinary Drink","Cocktail","Shake","Cocoa","Shot","Coffee / Tea")
    }

    val getGlasses: ()-> MutableList<String> = {
        mutableListOf("Cocktail glass","Old-fashioned glass","Whiskey Glass")
    }

    val getAlcoholicFilters: ()-> MutableList<String> = {
        mutableListOf("Alcoholic","Non alcoholic","Optional alcohol")
    }
}
